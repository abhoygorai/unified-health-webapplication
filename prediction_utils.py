...
def min_max_scaling(bmi, physical_health, mental_health, sleep_time):
    ...
    scaled_physical_health = (int(physical_health) - MIN_PHYSICAL_HEALTH) / (
        MAX_PHYSICAL_HEALTH - MIN_PHYSICAL_HEALTH
    )
    scaled_mental_health = (int(mental_health) - MIN_MENTAL_HEALTH) / (
        MAX_MENTAL_HEALTH - MIN_MENTAL_HEALTH
    )
    scaled_sleep_time = (int(sleep_time) - MIN_SLEEP_TIME) / (
...
def predict(
    ...
    bmi, physical_health, mental_health, sleep_time = min_max_scaling(
    ...
    df_dict = {
        ...
        "Race": race,
        "Diabetic": diabetic,
        "PhysicalActiviy": physical_activity,
